...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
...
},...N,...D,...M,S,$,...T,...j,K]}}})());hljs.registerLanguage("processing",(()=>{"use strict";return e=>({
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("glsl",(()=>{"use strict";return e=>({name:"GLSL",
keywords:{
...
className:"meta",begin:"#",end:"$"}]})})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
...
r.name="Arduino",r.aliases=["ino"],r.supersetOf="cpp",r}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
