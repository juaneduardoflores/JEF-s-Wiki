...
<div class="uk-position-relative" uk-slideshow="animation: fade">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="portfolio/residue/residue_001.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/residue/residue_002.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/residue/residue_003.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/residue/residue_004.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/residue/residue_005.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/residue/residue_006.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/residue/residue_007.jpg" alt="" uk-cover>
        </li>
    </ul>
    
    <div class="uk-position-bottom-center uk-position-small uk-visible@l">
        <ul class="uk-thumbnav">
            <li uk-slideshow-item="0"><a href="#"><img src="portfolio/residue/residue_001.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="1"><a href="#"><img src="portfolio/residue/residue_002.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="2"><a href="#"><img src="portfolio/residue/residue_003.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="3"><a href="#"><img src="portfolio/residue/residue_004.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="4"><a href="#"><img src="portfolio/residue/residue_005.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="5"><a href="#"><img src="portfolio/residue/residue_006.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="6"><a href="#"><img src="portfolio/residue/residue_007.jpg" width="100" alt=""></a></li>
        </ul>
    </div>
    
    <ul class="uk-thumbnav uk-margin uk-hidden@l">
	<li uk-slideshow-item="0" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_001.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="1" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_002.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="2" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_003.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="3" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_004.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="4" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_005.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="5" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_006.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="6" class="uk-margin"> <a href="#"><img src="portfolio/residue/residue_007.jpg" width="100" alt=""></a></li>
    </ul>
...
<div class="uk-position-relative" uk-slideshow="animation: fade">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="portfolio/transmitter/transmitter_002.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/transmitter/transmitter_003.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/transmitter/transmitter_004.jpg" alt="" uk-cover>
        </li>
    </ul>
    
    <div class="uk-position-bottom-center uk-position-small uk-visible@l">
        <ul class="uk-thumbnav">
            <li uk-slideshow-item="0"><a href="#"><img src="portfolio/transmitter/transmitter_002.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="1"><a href="#"><img src="portfolio/transmitter/transmitter_003.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="2"><a href="#"><img src="portfolio/transmitter/transmitter_004.jpg" width="100" alt=""></a></li>
        </ul>
    </div>
    
    <ul class="uk-thumbnav uk-margin uk-hidden@l">
	<li uk-slideshow-item="0" class="uk-margin"> <a href="#"><img src="portfolio/transmitter/transmitter_002.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="1" class="uk-margin"> <a href="#"><img src="portfolio/transmitter/transmitter_003.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="2" class="uk-margin"> <a href="#"><img src="portfolio/transmitter/transmitter_004.jpg" width="100" alt=""></a></li>
    </ul>
...
<div class="uk-position-relative" uk-slideshow="animation: fade">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="portfolio/post-data/post-data-001.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/post-data/post-data-002.jpg" alt="" uk-cover>
        </li>
        <li>
            <img src="portfolio/post-data/post-data-003.jpg" alt="" uk-cover>
        </li>
    </ul>
    
    <div class="uk-position-bottom-center uk-position-small uk-visible@l">
        <ul class="uk-thumbnav">
            <li uk-slideshow-item="0"><a href="#"><img src="portfolio/post-data/post-data-001.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="1"><a href="#"><img src="portfolio/post-data/post-data-002.jpg" width="100" alt=""></a></li>
            <li uk-slideshow-item="2"><a href="#"><img src="portfolio/post-data/post-data-003.jpg" width="100" alt=""></a></li>
        </ul>
    </div>
    
    <ul class="uk-thumbnav uk-margin uk-hidden@l">
	<li uk-slideshow-item="0" class="uk-margin"> <a href="#"><img src="portfolio/post-data/post-data-001.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="1" class="uk-margin"> <a href="#"><img src="portfolio/post-data/post-data-002.jpg" width="100" alt=""></a></li>
	<li uk-slideshow-item="2" class="uk-margin"> <a href="#"><img src="portfolio/post-data/post-data-003.jpg" width="100" alt=""></a></li>
    </ul>
...
<div class="uk-position-relative" uk-slideshow="animation: fade">
    ...
    <ul class="uk-slideshow-items">
        <li>
            <img src="portfolio/toy-instruments/toy-instruments_001.jpg" alt="" uk-cover>
        </li>
        <li>
...
It was not until my second year enrolled in Connecticut College, when I became enamored by artwork that involved [technology](technology). Up until then, work that involved coding, electronics, robotics, and other types of high-tech tools felt inaccessible for being expensive and requiring professional level training. While I took advantage of the tools available to me as a student fellow of the Ammerman Center for Arts and Technology, I quickly started to build a list of free and open source software and learning how to code. Of these new worlds that were new to me in creative art making, sound became one of the focuses I brought with me to Mexico City, funded by the Mortimer Hays-Brandeis Fellowship in 2016 after graduation. In Mexico I solidified my interests in work that was made by found electronics and accessible creative coding environments.
